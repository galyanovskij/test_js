...
function calculateVolumeAndArea(a) {
  if (a != null && typeof(a) != 'string' && Number.isInteger(a) && a != '' && !isNaN(a) && a > 0) {
...
function getCoupeNumber(a) {
  if (a != null && typeof(a) != 'string' && Number.isInteger(a) && a != '' && !isNaN(a) && a >=1 && a <=36 && a > 0) {
    if (a%4 === 0){
      console.log(a/4);
    }else {
      console.log(Math.floor(a/4)+1);
    }
